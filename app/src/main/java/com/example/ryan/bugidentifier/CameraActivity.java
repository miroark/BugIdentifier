...
//-----------------------------------------------------------------------------------------------------
    ...
    TextureView.SurfaceTextureListener textureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            // Transform the image to the new surface
        }
    ...
    }; //end of surface listener instantiation.
    ...
    } //end of active camera background
    ...
    protected void updatePreview() {
        if(null == cameraDevice) {
            Log.e(TAG, "updatePreview error, cameraDevice null");
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults[0] == PackageManager.PERMISSION_DENIED) {
                // close the app
                Toast.makeText(CameraActivity.this, "Permission to use camera denied.\nDisplaying previous captures.", Toast.LENGTH_LONG).show();
                //Later, instead of finishing send user to the pictureList_activity
                finish(); //end app
            }
        }
    }// end permissionResults()
}
